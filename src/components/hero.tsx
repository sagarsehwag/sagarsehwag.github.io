        ...
        <DialogContent className="flex h-[85vh] max-w-4xl flex-col gap-0 p-0 lg:max-w-5xl xl:max-w-6xl">
          <DialogHeader className="flex-none border-b px-4 py-3">
            <div className="flex items-center justify-between pr-8">
              <div>
                <DialogTitle className="text-base leading-normal">Resume</DialogTitle>
                <DialogDescription className="sr-only">Sagar Sehwag - Frontend Engineer Resume</DialogDescription>
              </div>
              <a
                href={RESUME_URL}
                target="_blank"
